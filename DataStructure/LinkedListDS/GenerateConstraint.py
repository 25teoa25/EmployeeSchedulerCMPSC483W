...
def generate_sorted_nurse_schedule_no_index_csv(departments, nurse_types, shifts=42, min_nurses=1, max_nurses=10, output_file="NurseContraints.csv"):
    """
