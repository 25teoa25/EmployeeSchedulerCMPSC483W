...
extern int satisfactionScoreGeneticAlgorithm; ///< Satisfaction score for Genetic Algorithm
extern int satisfactionScoreBruteForce;       ///< Satisfaction score for Brute Force
